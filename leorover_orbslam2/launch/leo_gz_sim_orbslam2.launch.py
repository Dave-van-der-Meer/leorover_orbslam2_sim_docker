...
def generate_launch_description():
    ...
    remappings = [
        ('/camera/rgb/image_raw', '/leo/realsense_d455/image'),
        ('/camera/depth_registered/image_raw', '/leo/realsense_d455/depth_image'),
        ('/camera/camera_info', '/leo/realsense_d455/camera_info'),
    ]
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            name='orb_slam2_odom_tf_publisher',
            arguments=['0.065', '0', '-0.441', '0', '-0.174', '0', '0.985', 'camera_link', 'leorover/base_footprint']
    )
    ])